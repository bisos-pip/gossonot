#+title: bisos.gossonot: python scripts (Interactive Command Modules -- ICM) which provide GOSSONOT (Generalized Open-Source Self Organizing Network Of Things) facilities.
